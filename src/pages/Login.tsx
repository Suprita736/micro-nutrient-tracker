...
export default function Login() {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            // Note: AppInit handles profile fetching on mount, 
            // but for immediate store update we could fetch here.
            // However, user requested Login -> Dashboard specifically.
            navigate("/dashboard");
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-end">
                            <button
                                ...
                                className="text-[11px] text-muted-foreground hover:text-primary font-sans transition-colors"
                            >
                                Forgot password?
                            </button>
                        </div>
